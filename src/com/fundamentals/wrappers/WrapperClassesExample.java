...
public class WrapperClassesExample {
	...
	public WrapperClassesExample() {
		// Até o Java 1.8
		/*wrapperLong = new Long(975452L);
		wrapperInteger = new Integer("15");
		wrapperDouble = new Double(452.78f);
		wrapperBoolean = new Boolean(true);*/
	...
	public void testConversions() {
		...
		// Converter Strings para tipos primitivos (Métodos Parse<Tipo> da classe wrapper correspondente):
