...
public class ArraysStructuresExample {
	...
	public void testCopyArray() {
		...
		/*
		 * Não é possível expandir um array atual, deve-se realizar uma cópia, definindo
		 * novo tamanho. Para isso, pode se utilizar Arrays.copyof do pacote java.util
		 * da classe utilitária Arrays.
		 */
	 ...
	 * São "arrays-de-arrays". Analogia básica (duas dimensões): Linha, Coluna.
	 * 
	 */
	public void testMultidimensionalArrays() {
		/*
		 * Formas válidas de inicialização. (Obs.: Primeira dimensão deve ser informada
		 * na inicialização).
		 */
		...
		String[][] locais2 = { { "Uberlândia", "Uberaba", "Belo Horizonte" }, { "Rio da Janeiro" },
	...
	/*
	 * Arrays como argumento podem ser declarados em qualquer posição. Para consumir
	 * o método, deve ser informada uma variável do mesmo tipo.
	 */
